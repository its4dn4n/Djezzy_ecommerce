...
<head>
    ...
    <title>ECODjezzy Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="user-management">
                    <a href="#user-management">User Management</a>
                                ...
                                <a href="#user-management-GETapi-user">Display User.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-POSTapi-user-update">
                                <a href="#user-management-POSTapi-user-update">Update User.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-DELETEapi-user">
                                <a href="#user-management-DELETEapi-user">Remove User.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="user-management-GETapi-logout">
                                <a href="#user-management-GETapi-logout">Log Out</a>
                            </li>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: April 7, 2023</li>
    </ul>
</div>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>APIs to manage the user resource.</p>
                                ...
                                <h2 id="user-management-GETapi-user">Display User.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        ...
        &quot;email&quot;: &quot;sydnie.morar@example.org&quot;
    }
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-management-POSTapi-user-update">Update User.</h2>
...
<span id="execution-results-POSTapi-user-update" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-user-update" style="max-height: 400px;"></code></pre>
</span>
...
<i>optional</i> &nbsp;
               ...
               value="lulu19@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>lulu19@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>G3!E]Hn1emyw</code></p>
        </div>
        </form>

                    <h2 id="user-management-DELETEapi-user">Remove User.</h2>
...
<span id="execution-results-DELETEapi-user" hidden>
    ...
    <pre class="json"><code id="execution-response-content-DELETEapi-user" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-user" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-user"></code></pre>
</span>
<form id="form-DELETEapi-user" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-user" hidden>Send Request 💥
            </button>
            </h3>
            <p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-management-GETapi-logout">Log Out</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="qmorar@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>qmorar@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="E7;VS[JT>4(lF$m"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>E7;VS[JT&gt;4(lF$m</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
